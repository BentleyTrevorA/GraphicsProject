...
public final class ARBFramebufferNoAttachments {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBFramebufferNoAttachments} instance for the current context. */
	...
	/** JNI method for {@link #glGetNamedFramebufferParameteriEXT(int, int, java.nio.ByteBuffer) GetNamedFramebufferParameteriEXT} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetNamedFramebufferParameteriEXT(int, int, java.nio.ByteBuffer) GetNamedFramebufferParameteriEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetNamedFramebufferParameteriEXT(int, int, java.nio.ByteBuffer) GetNamedFramebufferParameteriEXT} */
	...
	/** Single return value version of: {@link #glGetNamedFramebufferParameteriEXT(int, int, java.nio.ByteBuffer) GetNamedFramebufferParameteriEXT} */
