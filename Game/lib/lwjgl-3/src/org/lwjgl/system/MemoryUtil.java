...
public final class MemoryUtil {
	...
	/** Null-safe version of {@link #memAddress0(java.nio.Buffer)}. Returns {@link #NULL} if the specified buffer is null. */
	public static long memAddress0Safe(Buffer buffer) { return buffer == null ? NULL : ACCESSOR.getAddress(buffer); }

	/** PointerBuffer version of {@link #memAddress0(java.nio.Buffer)}. */
	public static long memAddress0(PointerBuffer buffer) { return ACCESSOR.getAddress(buffer.getBuffer()); }

	/** PointerBuffer version of {@link #memAddress0Safe(java.nio.Buffer)}. */
	 ...
	 * to this method should not own native memory, i.e. it should not be an instance created using {@link java.nio.ByteBuffer#allocateDirect}.
	...
	/**
	 * Encodes and optionally null-terminates the specified text using UTF-16 encoding. The encoded text is stored in the specified {@link java.nio.ByteBuffer}. The
	 ...
	 *
	 * @param buffer the {@link java.nio.ByteBuffer} that contains the string
	 *
	 ...
	 *
	 * @param buffer the {@link java.nio.ByteBuffer} to decode, or null
	 *
	 ...
	 * The current {@code position} and {@code limit} of the specified {@code buffer} are not affected by this operation.
	 *
	 * @param buffer the {@link java.nio.ByteBuffer} to decode
	 ...
	 *
	 * @param buffer  the {@link java.nio.ByteBuffer} to decode, or null
	 * @param charset the {@link java.nio.charset.Charset} to use for decoding
	 *
	 * @return the decoded {@link String} or null if the specified {@code buffer} is null
	 */
