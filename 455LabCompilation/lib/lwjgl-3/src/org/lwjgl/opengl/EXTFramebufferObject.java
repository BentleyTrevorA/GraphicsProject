...
public final class EXTFramebufferObject {
	...
	/** Returns the {@link org.lwjgl.opengl.EXTFramebufferObject} instance for the current context. */
	...
	/** JNI method for {@link #glGetRenderbufferParameteriEXT(int, int, java.nio.ByteBuffer) GetRenderbufferParameteriEXT} */
	@JavadocExclude
	public static native void nglGetRenderbufferParameterivEXT(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetRenderbufferParameteriEXT(int, int, java.nio.ByteBuffer) GetRenderbufferParameteriEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetRenderbufferParameteriEXT(int, int, java.nio.ByteBuffer) GetRenderbufferParameteriEXT} */
	...
	/** Single return value version of: {@link #glGetRenderbufferParameteriEXT(int, int, java.nio.ByteBuffer) GetRenderbufferParameteriEXT} */
	...
	/** JNI method for {@link #glGetFramebufferAttachmentParameteriEXT(int, int, int, java.nio.ByteBuffer) GetFramebufferAttachmentParameteriEXT} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetFramebufferAttachmentParameteriEXT(int, int, int, java.nio.ByteBuffer) GetFramebufferAttachmentParameteriEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetFramebufferAttachmentParameteriEXT(int, int, int, java.nio.ByteBuffer) GetFramebufferAttachmentParameteriEXT} */
	...
	/** Single return value version of: {@link #glGetFramebufferAttachmentParameteriEXT(int, int, int, java.nio.ByteBuffer) GetFramebufferAttachmentParameteriEXT} */
