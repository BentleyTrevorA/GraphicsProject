...
public final class GL42 {
	...
	/** Returns the {@link org.lwjgl.opengl.GL42} instance for the current context. */
	...
	/** JNI method for {@link #glGetActiveAtomicCounterBufferi(int, int, int, java.nio.ByteBuffer) GetActiveAtomicCounterBufferi} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetActiveAtomicCounterBufferi(int, int, int, java.nio.ByteBuffer) GetActiveAtomicCounterBufferi} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetActiveAtomicCounterBufferi(int, int, int, java.nio.ByteBuffer) GetActiveAtomicCounterBufferi} */
	...
	/** Single return value version of: {@link #glGetActiveAtomicCounterBufferi(int, int, int, java.nio.ByteBuffer) GetActiveAtomicCounterBufferi} */
	...
	/** JNI method for {@link #glGetInternalformati(int, int, int, int, java.nio.ByteBuffer) GetInternalformati} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetInternalformati(int, int, int, int, java.nio.ByteBuffer) GetInternalformati} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetInternalformati(int, int, int, int, java.nio.ByteBuffer) GetInternalformati} */
	...
	/** Single return value version of: {@link #glGetInternalformati(int, int, int, int, java.nio.ByteBuffer) GetInternalformati} */
