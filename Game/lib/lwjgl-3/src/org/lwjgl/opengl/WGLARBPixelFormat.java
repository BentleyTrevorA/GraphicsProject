...
public final class WGLARBPixelFormat {
	...
	/** Returns the {@link org.lwjgl.opengl.WGLARBPixelFormat} instance for the current context. */
	...
	/** JNI method for {@link #wglGetPixelFormatAttribiARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribiARB} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #wglGetPixelFormatAttribiARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribiARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #wglGetPixelFormatAttribiARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribiARB} */
	...
	/** Single value version of: {@link #wglGetPixelFormatAttribiARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribiARB} */
	...
	/** JNI method for {@link #wglGetPixelFormatAttribfARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribfARB} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #wglGetPixelFormatAttribfARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribfARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #wglGetPixelFormatAttribfARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribfARB} */
	...
	/** Single value version of: {@link #wglGetPixelFormatAttribfARB(long, int, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetPixelFormatAttribfARB} */
