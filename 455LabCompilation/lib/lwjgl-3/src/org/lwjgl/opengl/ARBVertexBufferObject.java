...
public final class ARBVertexBufferObject {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBVertexBufferObject} instance for the current context. */
	 ...
	 * <li>{@link #glMapBufferARB(int, int, java.nio.ByteBuffer)} - Calls {@link #glGetBufferParameteriARB GetBufferParameteriARB} to retrieve the buffer size and the {@code old_buffer} parameter is reused if the returned size and pointer match the buffer capacity and address, respectively.</li>
	 * <li>{@link #glMapBufferARB(int, int, int, java.nio.ByteBuffer)} - The buffer size is explicitly specified and the {@code old_buffer} parameter is reused if {@code size} and the returned pointer match the buffer capacity and address, respectively. This is the most efficient method.</li>
	 * </ol></p>
	 *
	...
	/** JNI method for {@link #glGetBufferParameteriARB(int, int, java.nio.ByteBuffer) GetBufferParameteriARB} */
	@JavadocExclude
	public static native void nglGetBufferParameterivARB(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferParameteriARB(int, int, java.nio.ByteBuffer) GetBufferParameteriARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferParameteriARB(int, int, java.nio.ByteBuffer) GetBufferParameteriARB} */
	public static void glGetBufferParameterARB(int target, int pname, IntBuffer params) {
		nglGetBufferParameterivARB(target, pname, memAddress(params));
	}

	/** Single return value version of: {@link #glGetBufferParameteriARB(int, int, java.nio.ByteBuffer) GetBufferParameteriARB} */
	...
	/** JNI method for {@link #glGetBufferPointerARB(int, int, java.nio.ByteBuffer) GetBufferPointerARB} */
	@JavadocExclude
	public static native void nglGetBufferPointervARB(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferPointerARB(int, int, java.nio.ByteBuffer) GetBufferPointerARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferPointerARB(int, int, java.nio.ByteBuffer) GetBufferPointerARB} */
	public static void glGetBufferPointerARB(int target, int pname, PointerBuffer params) {
		nglGetBufferPointervARB(target, pname, memAddress(params));
	}

	/** Single return value version of: {@link #glGetBufferPointerARB(int, int, java.nio.ByteBuffer) GetBufferPointerARB} */
