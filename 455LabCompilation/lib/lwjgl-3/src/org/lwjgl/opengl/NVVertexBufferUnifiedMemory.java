...
public final class NVVertexBufferUnifiedMemory {
	...
	/** Returns the {@link org.lwjgl.opengl.NVVertexBufferUnifiedMemory} instance for the current context. */
	...
	/** JNI method for {@link #glGetIntegerui64iNV(int, int, java.nio.ByteBuffer) GetIntegerui64iNV} */
	@JavadocExclude
	public static native void nglGetIntegerui64i_vNV(int value, int index, long result, long __functionAddress);

	/** Unsafe version of {@link #glGetIntegerui64iNV(int, int, java.nio.ByteBuffer) GetIntegerui64iNV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetIntegerui64iNV(int, int, java.nio.ByteBuffer) GetIntegerui64iNV} */
	...
	/** Single return value version of: {@link #glGetIntegerui64iNV(int, int, java.nio.ByteBuffer) GetIntegerui64iNV} */
