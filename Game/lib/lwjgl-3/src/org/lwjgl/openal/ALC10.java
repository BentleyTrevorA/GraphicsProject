...
public final class ALC10 {
	...
	/** Returns the {@link org.lwjgl.openal.ALC10} instance for the current context. */
	...
	/** JNI method for {@link #alcGetInteger(long, int, int, java.nio.ByteBuffer) GetInteger} */
	@JavadocExclude
	public static native void nalcGetIntegerv(long deviceHandle, int token, int size, long dest, long __functionAddress);

	/** Unsafe version of {@link #alcGetInteger(long, int, int, java.nio.ByteBuffer) GetInteger} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #alcGetInteger(long, int, int, java.nio.ByteBuffer) GetInteger} */
	...
	/** Single return value version of: {@link #alcGetInteger(long, int, int, java.nio.ByteBuffer) GetInteger} */
