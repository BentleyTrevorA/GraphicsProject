...
public final class GL32 {
	...
	/** Returns the {@link org.lwjgl.opengl.GL32} instance for the current context. */
	...
	/** JNI method for {@link #glGetBufferParameteri64(int, int, java.nio.ByteBuffer) GetBufferParameteri64} */
	@JavadocExclude
	public static native void nglGetBufferParameteri64v(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferParameteri64(int, int, java.nio.ByteBuffer) GetBufferParameteri64} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferParameteri64(int, int, java.nio.ByteBuffer) GetBufferParameteri64} */
	...
	/** Single return value version of: {@link #glGetBufferParameteri64(int, int, java.nio.ByteBuffer) GetBufferParameteri64} */
	...
	/** JNI method for {@link #glGetMultisamplef(int, int, java.nio.ByteBuffer) GetMultisamplef} */
	@JavadocExclude
	public static native void nglGetMultisamplefv(int pname, int index, long val, long __functionAddress);

	/** Unsafe version of {@link #glGetMultisamplef(int, int, java.nio.ByteBuffer) GetMultisamplef} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetMultisamplef(int, int, java.nio.ByteBuffer) GetMultisamplef} */
	...
	/** Single return value version of: {@link #glGetMultisamplef(int, int, java.nio.ByteBuffer) GetMultisamplef} */
	...
	/** JNI method for {@link #glGetInteger64(int, java.nio.ByteBuffer) GetInteger64} */
	@JavadocExclude
	public static native void nglGetInteger64v(int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetInteger64(int, java.nio.ByteBuffer) GetInteger64} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetInteger64(int, java.nio.ByteBuffer) GetInteger64} */
	...
	/** Single return value version of: {@link #glGetInteger64(int, java.nio.ByteBuffer) GetInteger64} */
	...
	/** JNI method for {@link #glGetInteger64i(int, int, java.nio.ByteBuffer) GetInteger64i} */
	@JavadocExclude
	public static native void nglGetInteger64i_v(int pname, int index, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetInteger64i(int, int, java.nio.ByteBuffer) GetInteger64i} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetInteger64i(int, int, java.nio.ByteBuffer) GetInteger64i} */
	...
	/** Single return value version of: {@link #glGetInteger64i(int, int, java.nio.ByteBuffer) GetInteger64i} */
	...
	/** JNI method for {@link #glGetSynci(long, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetSynci} */
	@JavadocExclude
	public static native void nglGetSynciv(long sync, int pname, int bufSize, long length, long values, long __functionAddress);

	/** Unsafe version of {@link #glGetSynci(long, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetSynci} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetSynci(long, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetSynci} */
	...
	/** Single return value version of: {@link #glGetSynci(long, int, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetSynci} */
