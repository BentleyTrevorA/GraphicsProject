...
public final class ARBUniformBufferObject {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBUniformBufferObject} instance for the current context. */
	...
	/** Unsafe version of {@link #glGetActiveUniformsi(int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer) GetActiveUniformsi} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetActiveUniformsi(int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer) GetActiveUniformsi} */
	...
	/** Single value version of: {@link #glGetActiveUniformsi(int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer) GetActiveUniformsi} */
	...
	/** Unsafe version of {@link #glGetActiveUniformBlocki(int, int, int, java.nio.ByteBuffer) GetActiveUniformBlocki} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetActiveUniformBlocki(int, int, int, java.nio.ByteBuffer) GetActiveUniformBlocki} */
	...
	/** Single return value version of: {@link #glGetActiveUniformBlocki(int, int, int, java.nio.ByteBuffer) GetActiveUniformBlocki} */
