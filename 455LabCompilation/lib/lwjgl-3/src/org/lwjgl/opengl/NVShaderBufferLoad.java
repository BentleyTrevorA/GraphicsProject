...
public final class NVShaderBufferLoad {
	...
	/** Returns the {@link org.lwjgl.opengl.NVShaderBufferLoad} instance for the current context. */
	...
	/** JNI method for {@link #glGetBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetBufferParameterui64NV} */
	@JavadocExclude
	public static native void nglGetBufferParameterui64vNV(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetBufferParameterui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetBufferParameterui64NV} */
	...
	/** Single return value version of: {@link #glGetBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetBufferParameterui64NV} */
	...
	/** JNI method for {@link #glGetNamedBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetNamedBufferParameterui64NV} */
	@JavadocExclude
	public static native void nglGetNamedBufferParameterui64vNV(int buffer, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetNamedBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetNamedBufferParameterui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetNamedBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetNamedBufferParameterui64NV} */
	...
	/** Single return value version of: {@link #glGetNamedBufferParameterui64NV(int, int, java.nio.ByteBuffer) GetNamedBufferParameterui64NV} */
	...
	/** JNI method for {@link #glGetIntegerui64NV(int, java.nio.ByteBuffer) GetIntegerui64NV} */
	@JavadocExclude
	public static native void nglGetIntegerui64vNV(int value, long result, long __functionAddress);

	/** Unsafe version of {@link #glGetIntegerui64NV(int, java.nio.ByteBuffer) GetIntegerui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetIntegerui64NV(int, java.nio.ByteBuffer) GetIntegerui64NV} */
	...
	/** Single return value version of: {@link #glGetIntegerui64NV(int, java.nio.ByteBuffer) GetIntegerui64NV} */
	...
	/** JNI method for {@link #glUniformui64NV(int, int, java.nio.ByteBuffer) Uniformui64NV} */
	@JavadocExclude
	public static native void nglUniformui64vNV(int location, int count, long value, long __functionAddress);

	/** Unsafe version of {@link #glUniformui64NV(int, int, java.nio.ByteBuffer) Uniformui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glUniformui64NV(int, int, java.nio.ByteBuffer) Uniformui64NV} */
	...
	/** JNI method for {@link #glGetUniformui64NV(int, int, java.nio.ByteBuffer) GetUniformui64NV} */
	@JavadocExclude
	public static native void nglGetUniformui64vNV(int program, int location, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetUniformui64NV(int, int, java.nio.ByteBuffer) GetUniformui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetUniformui64NV(int, int, java.nio.ByteBuffer) GetUniformui64NV} */
	...
	/** Single return value version of: {@link #glGetUniformui64NV(int, int, java.nio.ByteBuffer) GetUniformui64NV} */
	...
	/** JNI method for {@link #glProgramUniformui64NV(int, int, int, java.nio.ByteBuffer) ProgramUniformui64NV} */
	@JavadocExclude
	public static native void nglProgramUniformui64vNV(int program, int location, int count, long value, long __functionAddress);

	/** Unsafe version of {@link #glProgramUniformui64NV(int, int, int, java.nio.ByteBuffer) ProgramUniformui64NV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glProgramUniformui64NV(int, int, int, java.nio.ByteBuffer) ProgramUniformui64NV} */
