...
public final class ARBBindlessTexture {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBBindlessTexture} instance for the current context. */
	...
	/** JNI method for {@link #glUniformHandleui64ARB(int, int, java.nio.ByteBuffer) UniformHandleui64ARB} */
	@JavadocExclude
	public static native void nglUniformHandleui64vARB(int location, int count, long values, long __functionAddress);

	/** Unsafe version of {@link #glUniformHandleui64ARB(int, int, java.nio.ByteBuffer) UniformHandleui64ARB} */
	@JavadocExclude
	 ...
	 */
	public static void glUniformHandleui64ARB(int location, int count, ByteBuffer values) {
		if ( LWJGLUtil.CHECKS )
			checkBuffer(values, count << 3);
		nglUniformHandleui64vARB(location, count, memAddress(values));
	}

	/** Alternative version of: {@link #glUniformHandleui64ARB(int, int, java.nio.ByteBuffer) UniformHandleui64ARB} */
	public static void glUniformHandleuARB(int location, LongBuffer values) {
	...
	/** JNI method for {@link #glProgramUniformHandleui64ARB(int, int, int, java.nio.ByteBuffer) ProgramUniformHandleui64ARB} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glProgramUniformHandleui64ARB(int, int, int, java.nio.ByteBuffer) ProgramUniformHandleui64ARB} */
	@JavadocExclude
	 ...
	 * @param values   a buffer from which to load the handles
	 */
	public static void glProgramUniformHandleui64ARB(int program, int location, int count, ByteBuffer values) {
		if ( LWJGLUtil.CHECKS )
			checkBuffer(values, count << 3);
		nglProgramUniformHandleui64vARB(program, location, count, memAddress(values));
	}

	/** Alternative version of: {@link #glProgramUniformHandleui64ARB(int, int, int, java.nio.ByteBuffer) ProgramUniformHandleui64ARB} */
	...
	/** JNI method for {@link #glVertexAttribL1ui64ARB(int, java.nio.ByteBuffer) VertexAttribL1ui64ARB} */
	@JavadocExclude
	public static native void nglVertexAttribL1ui64vARB(int index, long v, long __functionAddress);

	/** Unsafe version of {@link #glVertexAttribL1ui64ARB(int, java.nio.ByteBuffer) VertexAttribL1ui64ARB} */
	@JavadocExclude
	 ...
	 */
	public static void glVertexAttribL1ui64ARB(int index, ByteBuffer v) {
		nglVertexAttribL1ui64vARB(index, memAddress(v));
	}

	/** Alternative version of: {@link #glVertexAttribL1ui64ARB(int, java.nio.ByteBuffer) VertexAttribL1ui64ARB} */
	...
	/** JNI method for {@link #glGetVertexAttribLui64ARB(int, int, java.nio.ByteBuffer) GetVertexAttribLui64ARB} */
	@JavadocExclude
	public static native void nglGetVertexAttribLui64vARB(int index, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetVertexAttribLui64ARB(int, int, java.nio.ByteBuffer) GetVertexAttribLui64ARB} */
	@JavadocExclude
	 ...
	 */
	public static void glGetVertexAttribLui64ARB(int index, int pname, ByteBuffer params) {
		if ( LWJGLUtil.CHECKS )
			checkBuffer(params, 1 << 3);
		nglGetVertexAttribLui64vARB(index, pname, memAddress(params));
	}

	/** Alternative version of: {@link #glGetVertexAttribLui64ARB(int, int, java.nio.ByteBuffer) GetVertexAttribLui64ARB} */
	...
	/** Single return value version of: {@link #glGetVertexAttribLui64ARB(int, int, java.nio.ByteBuffer) GetVertexAttribLui64ARB} */
