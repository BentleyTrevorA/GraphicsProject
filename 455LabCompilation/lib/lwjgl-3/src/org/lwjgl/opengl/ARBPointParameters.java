...
public final class ARBPointParameters {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBPointParameters} instance for the current context. */
	...
	/** JNI method for {@link #glPointParameterfARB(int, java.nio.ByteBuffer) PointParameterfARB} */
	@JavadocExclude
	public static native void nglPointParameterfvARB(int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glPointParameterfARB(int, java.nio.ByteBuffer) PointParameterfARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glPointParameterfARB(int, java.nio.ByteBuffer) PointParameterfARB} */
