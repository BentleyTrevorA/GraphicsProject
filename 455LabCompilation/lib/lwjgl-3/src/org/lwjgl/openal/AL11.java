...
public final class AL11 {
	...
	/** Returns the {@link org.lwjgl.openal.AL11} instance for the current context. */
	...
	/** JNI method for {@link #alListeneri(int, java.nio.ByteBuffer) Listeneri} */
	@JavadocExclude
	public static native void nalListeneriv(int listener, long value, long __functionAddress);

	/** Unsafe version of {@link #alListeneri(int, java.nio.ByteBuffer) Listeneri} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #alListeneri(int, java.nio.ByteBuffer) Listeneri} */
	...
	/** JNI method for {@link #alSourcei(int, int, java.nio.ByteBuffer) Sourcei} */
	@JavadocExclude
	public static native void nalSourceiv(int source, int paramName, long value, long __functionAddress);

	/** Unsafe version of {@link #alSourcei(int, int, java.nio.ByteBuffer) Sourcei} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #alSourcei(int, int, java.nio.ByteBuffer) Sourcei} */
	...
	/** JNI method for {@link #alBufferf(int, int, java.nio.ByteBuffer) Bufferf} */
	@JavadocExclude
	public static native void nalBufferfv(int buffer, int paramName, long value, long __functionAddress);

	/** Unsafe version of {@link #alBufferf(int, int, java.nio.ByteBuffer) Bufferf} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #alBufferf(int, int, java.nio.ByteBuffer) Bufferf} */
	...
	/** JNI method for {@link #alBufferi(int, int, java.nio.ByteBuffer) Bufferi} */
	@JavadocExclude
	public static native void nalBufferiv(int buffer, int paramName, long value, long __functionAddress);

	/** Unsafe version of {@link #alBufferi(int, int, java.nio.ByteBuffer) Bufferi} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #alBufferi(int, int, java.nio.ByteBuffer) Bufferi} */
