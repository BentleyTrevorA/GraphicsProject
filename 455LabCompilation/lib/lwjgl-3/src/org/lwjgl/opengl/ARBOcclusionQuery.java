...
public final class ARBOcclusionQuery {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBOcclusionQuery} instance for the current context. */
	...
	/** JNI method for {@link #glGetQueryiARB(int, int, java.nio.ByteBuffer) GetQueryiARB} */
	@JavadocExclude
	public static native void nglGetQueryivARB(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryiARB(int, int, java.nio.ByteBuffer) GetQueryiARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryiARB(int, int, java.nio.ByteBuffer) GetQueryiARB} */
	...
	/** Single return value version of: {@link #glGetQueryiARB(int, int, java.nio.ByteBuffer) GetQueryiARB} */
	...
	/** JNI method for {@link #glGetQueryObjectiARB(int, int, java.nio.ByteBuffer) GetQueryObjectiARB} */
	@JavadocExclude
	public static native void nglGetQueryObjectivARB(int id, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryObjectiARB(int, int, java.nio.ByteBuffer) GetQueryObjectiARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryObjectiARB(int, int, java.nio.ByteBuffer) GetQueryObjectiARB} */
	...
	/** Single return value version of: {@link #glGetQueryObjectiARB(int, int, java.nio.ByteBuffer) GetQueryObjectiARB} */
	...
	/** JNI method for {@link #glGetQueryObjectuiARB(int, int, java.nio.ByteBuffer) GetQueryObjectuiARB} */
	@JavadocExclude
	public static native void nglGetQueryObjectuivARB(int id, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryObjectuiARB(int, int, java.nio.ByteBuffer) GetQueryObjectuiARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryObjectuiARB(int, int, java.nio.ByteBuffer) GetQueryObjectuiARB} */
	...
	/** Single return value version of: {@link #glGetQueryObjectuiARB(int, int, java.nio.ByteBuffer) GetQueryObjectuiARB} */
