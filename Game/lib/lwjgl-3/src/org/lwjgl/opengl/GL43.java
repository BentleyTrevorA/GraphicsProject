...
public final class GL43 {
	...
	/** Returns the {@link org.lwjgl.opengl.GL43} instance for the current context. */
	...
	/** JNI method for {@link #glGetFramebufferParameteri(int, int, java.nio.ByteBuffer) GetFramebufferParameteri} */
	@JavadocExclude
	public static native void nglGetFramebufferParameteriv(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetFramebufferParameteri(int, int, java.nio.ByteBuffer) GetFramebufferParameteri} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetFramebufferParameteri(int, int, java.nio.ByteBuffer) GetFramebufferParameteri} */
	...
	/** Single return value version of: {@link #glGetFramebufferParameteri(int, int, java.nio.ByteBuffer) GetFramebufferParameteri} */
	...
	/** JNI method for {@link #glGetInternalformati64(int, int, int, int, java.nio.ByteBuffer) GetInternalformati64} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetInternalformati64(int, int, int, int, java.nio.ByteBuffer) GetInternalformati64} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetInternalformati64(int, int, int, int, java.nio.ByteBuffer) GetInternalformati64} */
	...
	/** Single return value version of: {@link #glGetInternalformati64(int, int, int, int, java.nio.ByteBuffer) GetInternalformati64} */
	...
	/** JNI method for {@link #glGetProgramInterfacei(int, int, int, java.nio.ByteBuffer) GetProgramInterfacei} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetProgramInterfacei(int, int, int, java.nio.ByteBuffer) GetProgramInterfacei} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetProgramInterfacei(int, int, int, java.nio.ByteBuffer) GetProgramInterfacei} */
	...
	/** Single return value version of: {@link #glGetProgramInterfacei(int, int, int, java.nio.ByteBuffer) GetProgramInterfacei} */
	...
	/** JNI method for {@link #glGetProgramResourcei(int, int, int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetProgramResourcei} */
	@JavadocExclude
	...
	/** Unsafe version of {@link #glGetProgramResourcei(int, int, int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetProgramResourcei} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetProgramResourcei(int, int, int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetProgramResourcei} */
	...
	/** Buffer return version of: {@link #glGetProgramResourcei(int, int, int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer, java.nio.ByteBuffer) GetProgramResourcei} */
