...
public final class GL31 {
	...
	/** Returns the {@link org.lwjgl.opengl.GL31} instance for the current context. */
	...
	/** JNI method for {@link #glGetActiveUniformsi(int, int, java.nio.ByteBuffer, int, java.nio.ByteBuffer) GetActiveUniformsi} */
	@JavadocExclude
	...
	/** JNI method for {@link #glGetActiveUniformBlocki(int, int, int, java.nio.ByteBuffer) GetActiveUniformBlocki} */
	@JavadocExclude
