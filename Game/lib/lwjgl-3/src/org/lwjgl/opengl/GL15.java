...
public final class GL15 {
	...
	/** Returns the {@link org.lwjgl.opengl.GL15} instance for the current context. */
	 ...
	 * <li>{@link #glMapBuffer(int, int, java.nio.ByteBuffer)} - Calls {@link #glGetBufferParameteri GetBufferParameteri} to retrieve the buffer size and the {@code old_buffer} parameter is reused if the returned size and pointer match the buffer capacity and address, respectively.</li>
	 * <li>{@link #glMapBuffer(int, int, int, java.nio.ByteBuffer)} - The buffer size is explicitly specified and the {@code old_buffer} parameter is reused if {@code size} and the returned pointer match the buffer capacity and address, respectively. This is the most efficient method.</li>
	 * </ol></p>
	 *
	...
	/** JNI method for {@link #glGetBufferParameteri(int, int, java.nio.ByteBuffer) GetBufferParameteri} */
	@JavadocExclude
	public static native void nglGetBufferParameteriv(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferParameteri(int, int, java.nio.ByteBuffer) GetBufferParameteri} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferParameteri(int, int, java.nio.ByteBuffer) GetBufferParameteri} */
	...
	/** Single return value version of: {@link #glGetBufferParameteri(int, int, java.nio.ByteBuffer) GetBufferParameteri} */
	...
	/** JNI method for {@link #glGetBufferPointer(int, int, java.nio.ByteBuffer) GetBufferPointer} */
	@JavadocExclude
	public static native void nglGetBufferPointerv(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetBufferPointer(int, int, java.nio.ByteBuffer) GetBufferPointer} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetBufferPointer(int, int, java.nio.ByteBuffer) GetBufferPointer} */
	...
	/** Single return value version of: {@link #glGetBufferPointer(int, int, java.nio.ByteBuffer) GetBufferPointer} */
	...
	/** JNI method for {@link #glGetQueryi(int, int, java.nio.ByteBuffer) GetQueryi} */
	@JavadocExclude
	public static native void nglGetQueryiv(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryi(int, int, java.nio.ByteBuffer) GetQueryi} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryi(int, int, java.nio.ByteBuffer) GetQueryi} */
	...
	/** Single return value version of: {@link #glGetQueryi(int, int, java.nio.ByteBuffer) GetQueryi} */
	...
	/** JNI method for {@link #glGetQueryObjecti(int, int, java.nio.ByteBuffer) GetQueryObjecti} */
	@JavadocExclude
	public static native void nglGetQueryObjectiv(int id, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryObjecti(int, int, java.nio.ByteBuffer) GetQueryObjecti} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryObjecti(int, int, java.nio.ByteBuffer) GetQueryObjecti} */
	...
	/** Single return value version of: {@link #glGetQueryObjecti(int, int, java.nio.ByteBuffer) GetQueryObjecti} */
	...
	/** JNI method for {@link #glGetQueryObjectui(int, int, java.nio.ByteBuffer) GetQueryObjectui} */
	@JavadocExclude
	public static native void nglGetQueryObjectuiv(int id, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetQueryObjectui(int, int, java.nio.ByteBuffer) GetQueryObjectui} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetQueryObjectui(int, int, java.nio.ByteBuffer) GetQueryObjectui} */
	...
	/** Single return value version of: {@link #glGetQueryObjectui(int, int, java.nio.ByteBuffer) GetQueryObjectui} */
