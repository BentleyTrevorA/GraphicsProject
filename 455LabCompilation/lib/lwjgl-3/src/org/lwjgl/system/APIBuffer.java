...
public class APIBuffer {
	...
	/** Returns the memory address of the internal {@link java.nio.ByteBuffer}. This address may change after a call to one of the {@code <type>Param()} methods. */
	public long address() {
		return address;
	}

	/** Returns the {@link java.nio.ByteBuffer} that backs this {@link org.lwjgl.system.APIBuffer}. */
