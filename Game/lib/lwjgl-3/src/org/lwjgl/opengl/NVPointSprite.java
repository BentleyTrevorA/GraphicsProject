 ...
 * 
 * <p>The goal of this extension is to allow such apps to use points rather than quads. When {@link #GL_GL_POINT_SPRITE_NV GL_POINT_SPRITE_NV} is enabled, the state of point antialiasing
...
public final class NVPointSprite {
	...
	/** Returns the {@link org.lwjgl.opengl.NVPointSprite} instance for the current context. */
	...
	/** JNI method for {@link #glPointParameteriNV(int, java.nio.ByteBuffer) PointParameteriNV} */
	@JavadocExclude
	public static native void nglPointParameterivNV(int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glPointParameteriNV(int, java.nio.ByteBuffer) PointParameteriNV} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glPointParameteriNV(int, java.nio.ByteBuffer) PointParameteriNV} */
