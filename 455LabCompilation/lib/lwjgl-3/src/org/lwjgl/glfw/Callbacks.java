...
public final class Callbacks {
	...
	/**
	 * Returns a {@link GLFWErrorCallback} instance that prints the error in the specified {@link java.io.PrintStream}.
	 *
	...
	/**
	 * Converts the specified {@link GLFWErrorCallback} description string pointer to a {@link java.nio.ByteBuffer}, with a capacity equal to the UTF-8 encoded string.
	 * <p/>
	...
	/** A functional interface that can be used with {@link #dropCallbackNamesApply(int, long, org.lwjgl.glfw.Callbacks.DropConsumerBuffer) dropCallbackNamesApply}. */
	public interface DropConsumerBuffer {
		void accept(int index, ByteBuffer name);
	}

	/** A functional interface that can be used with {@link #dropCallbackNamesApply(int, long, org.lwjgl.glfw.Callbacks.DropConsumerString) dropCallbackNamesApply}. */
	public interface DropConsumerString {
		void accept(int index, String name);
	}

	/**
	 * Applies the specified {@link org.lwjgl.glfw.Callbacks.DropConsumerBuffer} to the specified {@link GLFWDropCallback} arguments.
	 * <p/>
	 * This method may only be used inside a GLFWdropCallback invocation.
	 *
	 * @param count    the number of dropped files
	...
	/**
	 * Applies the specified {@link org.lwjgl.glfw.Callbacks.DropConsumerString} to the specified {@link GLFWDropCallback} arguments.
	 * <p/>
	 * This method may only be used inside a GLFWdropCallback invocation.
	 *
	 * @param count    the number of dropped files
