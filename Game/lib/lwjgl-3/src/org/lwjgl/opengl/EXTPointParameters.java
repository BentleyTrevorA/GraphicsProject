...
public final class EXTPointParameters {
	...
	/** Returns the {@link org.lwjgl.opengl.EXTPointParameters} instance for the current context. */
	...
	/** JNI method for {@link #glPointParameterfEXT(int, java.nio.ByteBuffer) PointParameterfEXT} */
	@JavadocExclude
	public static native void nglPointParameterfvEXT(int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glPointParameterfEXT(int, java.nio.ByteBuffer) PointParameterfEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glPointParameterfEXT(int, java.nio.ByteBuffer) PointParameterfEXT} */
