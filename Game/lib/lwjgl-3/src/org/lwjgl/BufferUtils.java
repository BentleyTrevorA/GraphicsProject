 ...
 * will often also use the current buffer limit (via {@link java.nio.Buffer#remaining()}) to automatically pass length/maxlength arguments. This means that, just like
 * other APIs that use NIO buffers, the current {@link java.nio.Buffer#position()} and {@link java.nio.Buffer#limit()} at the time of the call is very important. Contrary to
