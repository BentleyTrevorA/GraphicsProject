...
public final class ARBMatrixPalette {
	...
	/** Returns the {@link org.lwjgl.opengl.ARBMatrixPalette} instance for the current context. */
	...
	/** JNI method for {@link #glMatrixIndexuiARB(int, java.nio.ByteBuffer) MatrixIndexuiARB} */
	@JavadocExclude
	public static native void nglMatrixIndexuivARB(int size, long indices, long __functionAddress);

	/** Unsafe version of {@link #glMatrixIndexuiARB(int, java.nio.ByteBuffer) MatrixIndexuiARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glMatrixIndexuiARB(int, java.nio.ByteBuffer) MatrixIndexuiARB} */
	...
	/** JNI method for {@link #glMatrixIndexubARB(int, java.nio.ByteBuffer) MatrixIndexubARB} */
	@JavadocExclude
	public static native void nglMatrixIndexubvARB(int size, long indices, long __functionAddress);

	/** Unsafe version of {@link #glMatrixIndexubARB(int, java.nio.ByteBuffer) MatrixIndexubARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glMatrixIndexubARB(int, java.nio.ByteBuffer) MatrixIndexubARB} */
	...
	/** JNI method for {@link #glMatrixIndexusARB(int, java.nio.ByteBuffer) MatrixIndexusARB} */
	@JavadocExclude
	public static native void nglMatrixIndexusvARB(int size, long indices, long __functionAddress);

	/** Unsafe version of {@link #glMatrixIndexusARB(int, java.nio.ByteBuffer) MatrixIndexusARB} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glMatrixIndexusARB(int, java.nio.ByteBuffer) MatrixIndexusARB} */
