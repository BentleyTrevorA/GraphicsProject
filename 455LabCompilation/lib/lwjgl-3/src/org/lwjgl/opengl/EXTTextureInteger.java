...
public final class EXTTextureInteger {
	...
	/** Returns the {@link org.lwjgl.opengl.EXTTextureInteger} instance for the current context. */
	...
	/** JNI method for {@link #glTexParameterIiEXT(int, int, java.nio.ByteBuffer) TexParameterIiEXT} */
	@JavadocExclude
	public static native void nglTexParameterIivEXT(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glTexParameterIiEXT(int, int, java.nio.ByteBuffer) TexParameterIiEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glTexParameterIiEXT(int, int, java.nio.ByteBuffer) TexParameterIiEXT} */
	...
	/** Single value version of: {@link #glTexParameterIiEXT(int, int, java.nio.ByteBuffer) TexParameterIiEXT} */
	...
	/** JNI method for {@link #glTexParameterIuiEXT(int, int, java.nio.ByteBuffer) TexParameterIuiEXT} */
	@JavadocExclude
	public static native void nglTexParameterIuivEXT(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glTexParameterIuiEXT(int, int, java.nio.ByteBuffer) TexParameterIuiEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glTexParameterIuiEXT(int, int, java.nio.ByteBuffer) TexParameterIuiEXT} */
	...
	/** Single value version of: {@link #glTexParameterIuiEXT(int, int, java.nio.ByteBuffer) TexParameterIuiEXT} */
	...
	/** JNI method for {@link #glGetTexParameterIiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIiEXT} */
	@JavadocExclude
	public static native void nglGetTexParameterIivEXT(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetTexParameterIiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIiEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetTexParameterIiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIiEXT} */
	...
	/** Single return value version of: {@link #glGetTexParameterIiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIiEXT} */
	...
	/** JNI method for {@link #glGetTexParameterIuiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIuiEXT} */
	@JavadocExclude
	public static native void nglGetTexParameterIuivEXT(int target, int pname, long params, long __functionAddress);

	/** Unsafe version of {@link #glGetTexParameterIuiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIuiEXT} */
	@JavadocExclude
	...
	/** Alternative version of: {@link #glGetTexParameterIuiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIuiEXT} */
	...
	/** Single return value version of: {@link #glGetTexParameterIuiEXT(int, int, java.nio.ByteBuffer) GetTexParameterIuiEXT} */
